...
# include "../iterators/iterator_rbt_set.hpp"
...
namespace ft
{
	...
	class RBT_set
	{
		...
		public:
			...
			typedef typename ft::iterator_rbt_set<value_type, Node>					iterator;
			typedef typename ft::iterator_rbt_set<const_value_type, Node>			const_iterator;

			/* CONSTRUCTORS */
			explicit RBT_set(const allocator_type& alloc = allocator_type(), const value_compare& comp = value_compare());
			RBT_set(const RBT_set &cpy);
			~RBT_set();
